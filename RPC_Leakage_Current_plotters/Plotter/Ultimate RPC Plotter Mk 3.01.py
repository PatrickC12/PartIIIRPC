...
class CSVPlotterApp:
    ...
    def plot_selected(self, folder_path):
        ...
        for file, color_index in zip(selected_files, range(len(selected_files))):
            ...
            colors = plt.cm.rainbow(np.linspace(0, 0.3, len(selected_files)))  # Generate a list of colors. Messed around with this to avoid the cyan.
            ...
            sns.lineplot(x=data['Voltage/kV'], y=data['Current/uA'], label=file,marker='o', markersize=5, color = color) 
