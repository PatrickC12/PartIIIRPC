...
class CSVPlotterApp:
    ...
    def find_best_threshold(self, data):
        ...
        for threshold in np.linspace(data['Voltage/kV'].min(), data['Voltage/kV'].max(), 100):
            ...
            if len(linear_data) < 3:
                ...
                #Don't want only 2 data points, of course this would minimise error!
                continue
    ...
    def load_folder(self):
        ...
        self.fit_lines_chk = ttk.Checkbutton(self.frame, text="Fit Linear Region", variable=self.fit_lines_var)
