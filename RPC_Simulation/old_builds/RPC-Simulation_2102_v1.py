...
class RPCSimulatorApp:
    ...
    def create_rpc_attributes_ui(self, rpc_window):
        ...
        for gas in self.gases:
            self.selected_gases[gas] = tk.BooleanVar()
            chk = ttk.Checkbutton(rpc_window, text=gas, variable=self.selected_gases[gas])
            chk.pack(anchor='w')
    ...
    def save_rpc(self, rpc_window):
        ...
        dimensions = [float(self.x_var.get()), float(self.y_var.get())]
